...
function LandingPageContent({ onLogin, onSignup }: LandingPageProps) {
  return (
    <div
...
export default function Page() {
  ...
  return <LandingPageContent onLogin={() => router.push("/Login")} onSignup={() => router.push("/Cadastro")} />;
}

export { LandingPageContent as LandingPage };